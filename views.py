...
def register(request):
    if request.method=="POST":
        ...
        compare_user = User.objects.exclude(email=email)
        password_c = request.POST['password_c']
        if all_user != compare_user:
            return render(request,"register.html",{"username":username,"email":email,"password":password,"all_user":all_user,"compare_user":compare_user})
        else:
            ...
            activate.save()
            return render(request,"regsend.html",{"all_email":all_email})
    else:
